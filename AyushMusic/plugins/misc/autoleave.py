...
from AyushMusic.core.call import Aru, autoend, counter
from AyushMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
                ...
                async for i in client.get_dialogs():
                    if i.chat.type in [ChatType.SUPERGROUP, ChatType.GROUP, ChatType.CHANNEL]:
                        if (i.chat.id != config.LOG_GROUP_ID 
                            and i.chat.id != -1001801976314 
                            and i.chat.id != --1002106071049 
                            and i.chat.id != -1002665074802):
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Aru.call_listeners(chat_id))
